...
const SignUp = () => {
  ...
  const handleRegistrationForm = async (e: React.FormEvent<HTMLElement>) => {
    ...
    try {
      const SignUpData = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_URL}/api/user/createUser`, {
        method: 'POST',
        headers: {
            ...
            >
              ...
              <div className='col-span-6 sm:col-span-3'>
                ...
                <input
                  ...
                  className='mt-1 py-2 px-2 border  w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm'
                />
              </div>
